...
class ChatGPTAPI: @unchecked Sendable {
    ...
    init(apiKey: String, model: String = "gpt-3.5-turbo", systemPrompt: String = "You are a helpful assistant", temperature: Double = 0.5) {
       ...
       // self.systemMessage = .init(message_id:"", prompt: systemPrompt, conversation_id:"", response:systemPrompt)
    ...
    private func appendToHistoryList(userText: String, responseText: String) {
       // self.historyList.append(.init(message_id:"",prompt: userText,conversation_id:"",response:userText))
        self.historyList.append(.init(role: "assistant", content: responseText))
       // self.historyList.append(.init(message_id:"", prompt: "", conversation_id: "", response: responseText))
    }
